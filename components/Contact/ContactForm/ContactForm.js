...
export default function ContactForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        toast.error(json?.error || "Verzenden is niet gelukt");
      } else {
        toast.success("Succesvol verzonden");
        setFullname("");
        setEmail("");
      ...
      console.error(err);
      toast.error("Verzenden is niet gelukt");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="mx-auto block w-[1270px] max-[1450px]:w-[1100px] max-[1250px]:w-[1000px] max-[1100px]:w-[850px] max-[950px]:w-full">
      <form onSubmit={handleSubmit} className="flex flex-col px-8 py-8">
        <h1 className="text-4xl bold pb-4 text-center max-[750px]:text-3xl max-[500px]:text-2xl max-[355px]:text-xl">
          Verstuur hier je bericht
        </h1>
        ...
        <input
          ...
          id="naam"
          required
          className="bg-white border-b py-2 pl-4 focus:outline-none rounded-md focus:ring-2 ring-black font-light text-gray-500 max-[500px]:text-sm"
        />
        ...
        <textarea
          ...
          className="h-60 bg-white border-b py-2 pl-4 focus:outline-none rounded-md focus:ring-2 ring-black font-light text-gray-500 max-[500px]:text-sm"
        />
        ...
        <div className="flex flex-row items-center justify-start">
          <button
            type="submit"
            disabled={loading}
            className="px-10 mt-6 py-2 bg-black text-yellow-400 hover:text-white duration-300 bold rounded-full text-lg flex flex-row items-center"
          >
